 ...
 *
 */
abstract class GraphicsConsoleParent extends JPanel implements ActionListener, KeyListener, MouseListener, MouseWheelListener {
    ...
    public GraphicsConsoleParent(String title, int width, int height) {
        ...
        frame.setSize(new Dimension(frame.getWidth() - (getWidth() - width) - 10, frame.getHeight() - (getHeight() - height) - 10));
    }
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getButton() == 1 && !buttonsDown[0]) {
            buttonsDown[0] = true;
        } else if (e.getButton() == 2 && !buttonsDown[1]) {
            buttonsDown[1] = true;
        } else if (e.getButton() == 3 && !buttonsDown[2]) {
            buttonsDown[2] = true;
        }
    }
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        mouseWheel -= e.getPreciseWheelRotation() * 0.2;
        mouseWheel = mouseWheel < 0.20 ? 0.20 : mouseWheel;
        mouseWheel = mouseWheel > 5 ? 5 : mouseWheel;
    }
